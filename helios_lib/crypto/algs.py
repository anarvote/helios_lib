...
class EGZKProof(object):
    def __init__(self, commitment=None, challenge=None, response=None):
        self.commitment = commitment or {'A': None, 'B': None}
        self.challenge = challenge and int(challenge)
        self.response = response and int(response)
        self.commitment['A'] = self.commitment['A'] and int(self.commitment['A'])
        self.commitment['B'] = self.commitment['B'] and int(self.commitment['B'])
